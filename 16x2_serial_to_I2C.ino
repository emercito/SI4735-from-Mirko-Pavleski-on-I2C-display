/*
  ...
  | ----------------          | ----------------------------- | ------------  |
  |    LCD 16x2 or 20x4       |                               |               |
  | Please check the address  | SDA                           |     A4        | Modified to connect the I2C display devices.
  | of your device first      | SCL                           |     A5        | Modified to connect the I2C display devices.
  |                           |                               |               |
  |                           |                               |               |
  |                           |                               |               |
  |                           |                               |               |
...
#include <SI4735.h>
#include <LiquidCrystal_I2C.h> // added to initialise the I2C 16x2 LCD library by Emerson capuano
#include "Rotary.h"
...
// Buttons controllers
#define ENCODER_PUSH_BUTTON A0      // Pin A0/14
#define DUMMY_BUTTON 8
...
LiquidCrystal_I2C lcd(0x3f, 16, 2); //added to work with I2C 16x2 LCD devices by Emerson Capuano
SI4735 rx;
...
void setup()
{
  ...
  lcd.backlight();  //added to turn on the backligh of I2C display devices by Emerson Capuano
  lcd.begin(16, 2);
